...
//                 <button
//                   onClick={() => fetchCourseVideos(course.id)}
          ...
          <div key={index} className="bg-white shadow-md rounded-lg p-4">
            ...
            {isAdmin ? (
              ...
              <>
                ...
                {/* Link to the course videos page */}
                <Link
                  to={`/course-videos/${course.id}`}
                  className="mt-4 bg-purple-500 text-white px-4 py-2 rounded block text-center"
                >
                  Show Videos
                </Link>
              </>
